...
describe "tag regexp expression" do
  ...
  it "interprets tag regexp with host" do
    ...
    expect(expr.optimize.dump).to eq({tagname_regexp: "host", separator: ":", tagvalue_regexp: "foo"})
  end
  ...
  it "interprets tag regexp with tagname and tagvalue" do
    ...
    expect(expr.optimize.dump).to eq({tagname_regexp: "foo", separator: ":", tagvalue_regexp: "bar"})
  end
  ...
  it "interprets tag regexp with tagname with separator" do
    ...
    expect(expr.optimize.dump).to eq({tagname_regexp: "foo", separator: ":"})
  end
  ...
  it "interprets tag regexp with tagname without separator" do
    ...
    expect(expr.optimize.dump).to eq({tagname_regexp: "foo"})
  end
  ...
  it "interprets tag regexp with tagvalue with separator" do
    ...
    expect(expr.optimize.dump).to eq({separator: ":", tagvalue_regexp: "foo"})
  end
  ...
  it "interprets tag regexp with tagvalue without separator" do
    ...
    expect(expr.optimize.dump).to eq({tagvalue_regexp: "foo"})
  end
